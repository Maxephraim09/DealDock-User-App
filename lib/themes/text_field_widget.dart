...
class _TextFieldWidgetState extends State<TextFieldWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    final effectiveFocusBorderColor = widget.focusBorderColor ?? borderColor;
    ...
    return Column(
      ...
      children: [
        if (widget.title != null) ...[
          Text(
            widget.title!.tr,
            style: AppThemeData.boldTextStyle(fontSize: 14, color: titleColor),
          ),
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            errorStyle: TextStyle(color: AppThemeData.danger300),
            filled: true,
            ...
            errorBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(8),
              borderSide: BorderSide(color: AppThemeData.danger300),
            ),
