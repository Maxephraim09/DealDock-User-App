...
class AppThemeData {
  ...
  static const Color surfaceDark = Color(0xFF171A21); // Soft dark surface
  static const Color surfaceDarkCard = Color(
    0xFF1E222B,
  ); // Dark card background
  static const Color backgroundDark = Color(0xFF0F1115); // Dark app background

  // === Brand Colors ===
  static const Color brandPrimaryBlue = Color(0xFF30588C); // Main brand color
  static const Color brandDeepBlue = Color(
    0xFF2E608C,
  ); // Headers, emphasis, navigation
  static const Color brandMutedSteelBlue = Color(
    0xFF3D5A73,
  ...
  static const Color greyDark50 = Color(0xFFF9FAFB); // Light text in dark mode
  static const Color greyDark100 = Color(
    0xFFF3F4F6,
  ); // Primary text in dark mode
  static const Color greyDark200 = Color(0xFFE5E7EB); // Secondary text
  static const Color greyDark300 = Color(0xFFD1D5DB); // Tertiary text
  static const Color greyDark400 = Color(0xFF9CA3AF); // Disabled text
  static const Color greyDark500 = Color(0xFF6B7280); // Muted text
  static const Color greyDark600 = Color(0xFF4B5563); // Dark divider
  static const Color greyDark700 = Color(0xFF374151); // Dark border
  static const Color greyDark800 = Color(0xFF1F2937); // Soft dark card
  static const Color greyDark900 = Color(0xFF171A21); // Soft dark surface
  ...
  static Color primary300 = AppThemeData.brandPrimaryBlue;
