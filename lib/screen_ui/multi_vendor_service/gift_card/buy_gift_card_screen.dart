                          ...
                          onPress: () async {
                            if (controller
                              ...
                              if (Constant.userModel == null) {
                                ...
                                _giftCardBottomSheet(context, controller);
                              }
                            } else {
                              ShowToastDialog.showToast(
                  ...
                  () => Scaffold(
                    ...
                    bottomNavigationBar: Container(
                      ...
                      child: Padding(
                        ...
                        child: RoundedButtonFill(
                          title:
                              "Pay ₦${controller.amountController.value.text}",
                          height: 5.5,
                          color: const Color(0xFF30588C),
