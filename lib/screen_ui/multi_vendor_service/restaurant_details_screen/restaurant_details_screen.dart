...
class _RestaurantDetailsScreenState extends State<RestaurantDetailsScreen> {
  int selectedTab = 0; // 0 = Order, 1 = Hire
          ...
          body: Column(
            children: [
              ...
              Expanded(
                child:
                    selectedTab == 0
                        ? _buildRestaurantView(controller, isDark, context)
                  ...
                  controller.vendorModel.value.photos == null ||
                      ...
                      ? Stack(
                        children: [
                          NetworkImageWidget(
                            imageUrl:
                                controller.vendorModel.value.photo.toString(),
                            fit: BoxFit.cover,
                    ...
                    children: [
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            TextFieldWidget(
                              controller:
                                  controller.searchEditingController.value,
                            ...
                            const SizedBox(height: 10),
                            Constant.sectionConstantModel!.isProductDetails ==
                                    false
                                ? SizedBox()
                                : Row(
                                  children: [
                      ...
                      SizedBox(
                        ...
                        child: ListView.builder(
                          scrollDirection: Axis.horizontal,
                          itemCount: controller.vendorCategoryList.length + 1,
                          itemBuilder: (context, index) {
                            ...
                            VendorCategoryModel category =
                                controller.vendorCategoryList[index - 1];
                            return InkWell(
                              onTap: () {
                                controller.selectedCategoryId.value =
                                    category.id!;
...
class ProductListView extends StatelessWidget {
      ...
      child: GridView.count(
        ...
        children:
            controller.productList
                .map(
                  (productModel) =>
                      _buildProductCard(productModel, controller, isDark),
                )
                .toList(),
      ),
    );
  ...
  Widget _buildAddButton(
    ...
    return Obx(() {
      ...
      if (inCart) {
        final cartItemModel = cartItem.firstWhere(
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          IconButton(
                            onPressed: () {
                              if (quantity < (productModel.quantity ?? 0) ||
                                  (productModel.quantity ?? 0) == -1) {
                                setState(() => quantity++);
                              } else {
                                ShowToastDialog.showToast("Out of stock".tr);
