...
class MyBookingScreen extends StatelessWidget {
  ...
  Widget _buildBody(ParcelMyBookingController controller, bool isDark) {
    try {
            ...
            child: Column(
              ...
              children: [
                ...
                RoundedButtonFill(
                  ...
                  color: AppThemeData.primary300,
                  textColor: AppThemeData.grey50,
                  onPress: () => controller.listenParcelOrders(),
                ),
              ],
            ),
          ),
          ...
          controller.tabTitles.map((title) {
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final orderDate =
                    order.isSchedule == true
                        ? controller.formatDate(order.createdAt!)
                        : controller.formatDate(
                          order.senderPickupDateTime ?? order.createdAt!,
                        );
      ...
      return TabBarView(children: tabWidgets);
    } catch (e) {
      return Center(
        child: Text(
          "Error loading delivery history".tr,
          style: AppThemeData.mediumTextStyle(
