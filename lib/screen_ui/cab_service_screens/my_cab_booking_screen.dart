                                      ...
                                      children: [
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Column(
                                              children: [
                                                Icon(Icons.stop_circle_outlined, color: AppThemeData.success300),
                                                DottedBorder(
                                                ...
                                                Icon(Icons.radio_button_checked, color: AppThemeData.danger300),
                                              ],
                                            ),
    ...
    return DraggableScrollableSheet(
      ...
      builder: (context, scrollController) {
        return Container(
          ...
          decoration: BoxDecoration(color: isDark ? AppThemeData.grey500 : AppThemeData.surface, borderRadius: BorderRadius.vertical(top: Radius.circular(24))),
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Row(
