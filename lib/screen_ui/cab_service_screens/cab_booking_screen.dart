...
class CabBookingScreen extends StatelessWidget {
                      ...
                      Constant.selectedMapType == "osm"
                          ? flutterMap.FlutterMap(
                            ...
                            children: [
                              ...
                              if (controller.routePoints.isNotEmpty) flutterMap.PolylineLayer(polylines: [flutterMap.Polyline(points: controller.routePoints, strokeWidth: 5.0, color: AppThemeData.brandPrimaryBlue)]),
                            ],
                          )
                          : GoogleMap(
      ...
      child: DraggableScrollableSheet(
        ...
        builder: (context, scrollController) {
          return Container(
            ...
            decoration: BoxDecoration(color: isDark ? AppThemeData.grey700 : AppThemeData.surface, borderRadius: BorderRadius.vertical(top: Radius.circular(35))),
            child: Column(
              ...
              children: [
                ...
                Stack(
                  children: [
                    Container(
                      decoration: BoxDecoration(color: isDark ? AppThemeData.grey700 : AppThemeData.surface, borderRadius: BorderRadius.circular(12)),
                      child: Column(
                        mainAxisSize: MainAxisSize.min,
                        children: [
                          // Pickup Location
                          ...
                          InkWell(
                            ...
                            child: TextFieldWidget(
                              ...
                              enable: false,
                              prefix: const Padding(padding: EdgeInsets.only(left: 10, right: 10), child: Icon(Icons.radio_button_checked, color: AppThemeData.danger300)),
                            ),
                          ),
                        ],
                      ),
  ...
  Widget vehicleSelection(BuildContext context, CabBookingController controller, bool isDark) {
    return Positioned.fill(
      child: DraggableScrollableSheet(
        ...
        builder: (context, scrollController) {
          return Container(
            decoration: BoxDecoration(color: isDark ? AppThemeData.grey700 : AppThemeData.surface, borderRadius: const BorderRadius.only(topLeft: Radius.circular(24), topRight: Radius.circular(24))),
            child: Padding(
      ...
      child: DraggableScrollableSheet(
        ...
        builder: (context, scrollController) {
          return Container(
            ...
            decoration: BoxDecoration(color: isDark ? AppThemeData.grey700 : AppThemeData.surface, borderRadius: BorderRadius.vertical(top: Radius.circular(24))),
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Row(
      ...
      child: DraggableScrollableSheet(
        ...
        builder: (context, scrollController) {
          return GetX(
            ...
            builder: (controller) {
              return Container(
                decoration: BoxDecoration(color: isDark ? AppThemeData.grey700 : AppThemeData.surface, borderRadius: BorderRadius.only(topLeft: Radius.circular(30), topRight: Radius.circular(30))),
                child: Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 15.0, vertical: 10),
                  child: Column(
                    mainAxisSize: MainAxisSize.min,
                        ...
                        child: ListView(
                          ...
                          children: [
                                    ...
                                    children: [
                                      ...
                                      InkWell(
                                        ...
                                        child: TextFieldWidget(
                                          ...
                                          hintText: "Pickup Location".tr,
                                          enable: false,
                                          prefix: const Padding(padding: EdgeInsets.only(left: 10, right: 10), child: Icon(Icons.stop_circle_outlined, color: AppThemeData.success300)),
                                        ),
                                      ),
                                      const SizedBox(height: 10),
                                      // Destination Location
                            ...
                            Container(
                              ...
                              child: Row(
                                children: [
                                  _getPaymentMethodWidget(controller, isDark),
  ...
  Widget waitingDialog(BuildContext context, CabBookingController controller, bool isDark) {
    return Positioned.fill(
      child: DraggableScrollableSheet(
        ...
        builder: (context, scrollController) {
          return Container(
            decoration: BoxDecoration(color: AppThemeData.surface, borderRadius: BorderRadius.only(topLeft: Radius.circular(30), topRight: Radius.circular(30))),
            child: Padding(
              padding: const EdgeInsets.symmetric(horizontal: 15.0, vertical: 10),
              child: Column(
                mainAxisSize: MainAxisSize.min,
                    ...
                    if (controller.currentOrder.value.status == Constant.orderInTransit) {
                      return Column(
                        children: [
                          RoundedButtonFill(
                            title: "SOS".tr,
                            color: AppThemeData.danger300.withOpacity(0.50),
                            textColor: AppThemeData.grey50,
                            isCenter: true,
                            icon: const Icon(Icons.call, color: AppThemeData.surface),
                            onPress: () async {
                              ShowToastDialog.showLoader("Please wait...".tr);
                                ...
                                if (value == false) {
                                  await FireStoreUtils.setSos(controller.currentOrder.value.id ?? '', UserLocation(latitude: location.latitude!, longitude: location.longitude!)).then((_) {
                                    ...
                                    ScaffoldMessenger.of(
                                      context,
                                    ).showSnackBar(SnackBar(content: Text("Your SOS request has been submitted to admin".tr), backgroundColor: AppThemeData.success300, duration: Duration(seconds: 3)));
                                  });
                                } else {
                                  ShowToastDialog.closeLoader();
                                  ScaffoldMessenger.of(
                                    context,
                                  ).showSnackBar(SnackBar(content: Text("Your SOS request is already submitted".tr), backgroundColor: AppThemeData.danger300, duration: Duration(seconds: 3)));
                                }
                              });
                            },
                          ),
                      ...
                      return RoundedButtonFill(
                        ...
                        onPress: () async {
                          if (controller.selectedPaymentMethod.value == PaymentGateway.stripe.name) {
                            ...
                            if (Constant.userModel == null || Constant.userModel!.walletAmount == null || Constant.userModel!.walletAmount! < controller.totalAmount.value) {
  ...
  Padding cardDecorationScreen(CabBookingController controller, PaymentGateway value, isDark, String image) {
    return Padding(
      ...
      child: Container(
        width: 40,
        height: 40,
        decoration: ShapeDecoration(shape: RoundedRectangleBorder(side: const BorderSide(width: 1, color: AppThemeData.grey200), borderRadius: BorderRadius.circular(8))),
  ...
  Widget _getPaymentMethodWidget(CabBookingController controller, bool isDark) {
    final paymentMethod = controller.selectedPaymentMethod.value;

    if (paymentMethod.isEmpty) {
      return cardDecorationScreen(controller, PaymentGateway.wallet, isDark, "");
    }

    switch (paymentMethod) {
      case 'wallet':
        return cardDecorationScreen(controller, PaymentGateway.wallet, isDark, "assets/images/ic_wallet.png");
      case 'cod':
        return cardDecorationScreen(controller, PaymentGateway.cod, isDark, "assets/images/ic_cash.png");
      case 'stripe':
        return cardDecorationScreen(controller, PaymentGateway.stripe, isDark, "assets/images/stripe.png");
      case 'paypal':
        return cardDecorationScreen(controller, PaymentGateway.paypal, isDark, "assets/images/paypal.png");
      case 'payStack':
        return cardDecorationScreen(controller, PaymentGateway.payStack, isDark, "assets/images/paystack.png");
      case 'mercadoPago':
        return cardDecorationScreen(controller, PaymentGateway.mercadoPago, isDark, "assets/images/mercado-pago.png");
      case 'flutterWave':
        return cardDecorationScreen(controller, PaymentGateway.flutterWave, isDark, "assets/images/flutterwave_logo.png");
      case 'payFast':
        return cardDecorationScreen(controller, PaymentGateway.payFast, isDark, "assets/images/payfast.png");
      case 'midTrans':
        return cardDecorationScreen(controller, PaymentGateway.midTrans, isDark, "assets/images/midtrans.png");
      case 'orangeMoney':
        return cardDecorationScreen(controller, PaymentGateway.orangeMoney, isDark, "assets/images/orange_money.png");
      case 'xendit':
        return cardDecorationScreen(controller, PaymentGateway.xendit, isDark, "assets/images/xendit.png");
      default:
        return cardDecorationScreen(controller, PaymentGateway.razorpay, isDark, "assets/images/razorpay.png");
    }
  }
}
