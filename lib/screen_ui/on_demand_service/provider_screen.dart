                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: TextStyle(color: isDark ? Colors.white : Theme.of(context).textTheme.bodyMedium?.color ?? AppThemeData.grey900, fontFamily: AppThemeData.regular, fontSize: 20, fontWeight: FontWeight.w900),
                        ),
                        const SizedBox(height: 5),
                        Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            SvgPicture.asset("assets/icons/ic_mail.svg", color: isDark ? Colors.white : Theme.of(context).textTheme.bodyMedium?.color ?? AppThemeData.grey900),
                            const SizedBox(width: 6),
                            Text(
                              controller.userModel.value?.email ?? '',
                              style: TextStyle(color: isDark ? Colors.white : Theme.of(context).textTheme.bodyMedium?.color ?? AppThemeData.grey900, fontFamily: AppThemeData.regular, fontSize: 14, fontWeight: FontWeight.w500),
                            ),
                          ],
                        ),
                        Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            SvgPicture.asset("assets/icons/ic_mobile.svg", color: isDark ? Colors.white : Theme.of(context).textTheme.bodyMedium?.color ?? AppThemeData.grey900),
                            const SizedBox(width: 6),
                            Text(
