                                                    ...
                                                    children: [
                                                        ...
                                                        children: [
                                                          Expanded(
                                                            child: Text(
                                                              ...
                                                              style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: isDark ? Colors.white : Theme.of(context).textTheme.bodyMedium?.color ?? AppThemeData.grey900),
                                                            ),
                                                          ),
                                                          Obx(
                                                            () => GestureDetector(
                                                      ...
                                                      FutureBuilder<CategoryModel?>(
                                                        ...
                                                        builder: (ctx, snap) {
                                                          ...
                                                          return Text(snap.data?.title ?? "", style: TextStyle(fontSize: 14, color: isDark ? Colors.white : Theme.of(context).textTheme.bodyMedium?.color ?? AppThemeData.grey900));
                                                        },
                                                      ),
