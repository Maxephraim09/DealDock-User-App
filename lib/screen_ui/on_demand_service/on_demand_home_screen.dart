                              ...
                              children: [
                                Expanded(
                                  child: Text(
                                    ...
                                    style: TextStyle(color: isDark ? Colors.white : Theme.of(context).textTheme.bodyMedium?.color ?? AppThemeData.grey900, fontSize: 18, fontFamily: AppThemeData.regular, fontWeight: FontWeight.w600),
                                  ),
                                ),
                                InkWell(
                                  onTap: () {
                      ...
                      children: [
                        Expanded(
                          child: Text(
                            ...
                            maxLines: 1,
                            overflow: TextOverflow.ellipsis,
                            style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: isDark ? Colors.white : Theme.of(context).textTheme.bodyMedium?.color ?? AppThemeData.grey900),
                          ),
                        ),
                        if (controller != null)
                          Obx(
