                        ...
                        children: [
                          ...
                          InkWell(
                            ...
                            child: TextFieldWidget(
                              ...
                              enable: false,
                              prefix: Padding(padding: EdgeInsets.only(left: 10, right: 10), child: Icon(Icons.stop_circle_outlined, color: AppThemeData.success400)),
                            ),
                          ),
  ...
  Widget selectPreferences(BuildContext context, RentalHomeController controller, bool isDark) {
    return DraggableScrollableSheet(
      ...
      builder: (context, scrollController) {
        return Container(
          decoration: BoxDecoration(color: isDark ? AppThemeData.grey900 : AppThemeData.surface, borderRadius: const BorderRadius.only(topLeft: Radius.circular(24), topRight: Radius.circular(24))),
          child: Padding(
            padding: const EdgeInsets.symmetric(horizontal: 15.0, vertical: 10),
            child: Column(
              children: [
                // handle bar
                Container(height: 4, width: 33, decoration: BoxDecoration(borderRadius: BorderRadius.circular(10), color: AppThemeData.grey400)),

                Align(
                  alignment: Alignment.topLeft,
                  child: Padding(
                    padding: const EdgeInsets.symmetric(vertical: 10),
                      child: Text("Select Preferences".tr, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18, color: isDark ? AppThemeData.surface : AppThemeData.grey900)),
                  ),
                ),
    ...
    return DraggableScrollableSheet(
      ...
      builder: (context, scrollController) {
        return Container(
          ...
          decoration: BoxDecoration(color: isDark ? AppThemeData.grey500 : AppThemeData.surface, borderRadius: const BorderRadius.vertical(top: Radius.circular(24))),
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              // Header
