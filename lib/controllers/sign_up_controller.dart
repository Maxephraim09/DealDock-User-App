...
class SignUpController extends GetxController {
  ...
  Future<void> _saveSignupSessionState() async {
  ...
  Future<void> _showSignupSuccessAndNavigate() async {
    ShowToastDialog.closeLoader();
    ShowToastDialog.showToast("Account created successfully".tr);
    await Future.delayed(const Duration(milliseconds: 800));
    await _saveSignupSessionState();
    ...
    if (type.value == "google" ||
        ...
        if (userModel.value.shippingAddress != null &&
          ...
          if (userModel.value.shippingAddress!
            ...
            Constant.selectedLocation =
                userModel.value.shippingAddress!
                    .where((element) => element.isDefault == true)
                    .single;
          } else {
            Constant.selectedLocation = userModel.value.shippingAddress!.first;
          }
          await _showSignupSuccessAndNavigate();
      ...
      try {
        ...
        final confirmPassword =
            conformPasswordEditingController.value.text.trim();
        ...
        if (credential.user != null) {
          ...
          await FireStoreUtils.updateUser(userModel.value).then((value) async {
            ...
            try {
              ...
              ShowToastDialog.showToast("Account created successfully".tr);
              ShowToastDialog.showToast(
                "Account created but failed to send verification email.".tr,
              );
            }
            await Future.delayed(const Duration(milliseconds: 800));
            ShowToastDialog.closeLoader();
