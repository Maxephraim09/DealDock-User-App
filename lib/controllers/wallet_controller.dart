...
class WalletController extends GetxController {
  ...
  Future<bool> walletTopUp({
    bool showToast = true,
    bool popOnSuccess = true,
  }) async {
    final String rawAmount =
        topUpAmountController.value.text.replaceAll(',', '').trim();
  ...
  Future<bool> createPendingCryptoTransaction({
    ...
    WalletTransactionModel transactionModel = WalletTransactionModel(
      ...
      userId: FireStoreUtils.getCurrentUid(),
      isTopup: true,
      note: "Crypto deposit pending: $cryptoCurrency",
      paymentStatus: "pending",
      orderId: reference,
      serviceType: "crypto",
    );

    final bool? saved = await FireStoreUtils.setWalletTransaction(
      transactionModel,
    );
    if (saved == true) {
