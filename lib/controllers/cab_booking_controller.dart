...
class CabBookingController extends GetxController {
  ...
  StreamSubscription<DocumentSnapshot>? _rideSnapshotSubscription;
  StreamSubscription<DocumentSnapshot>? _driverSnapshotSubscription;
  ...
  Future<void> getVehicleType() async {
    ...
    // ✅ FIX: Properly manage user snapshot subscription
    _userSnapshotSubscription?.cancel();
    _userSnapshotSubscription = FireStoreUtils.fireStore
        ...
        .listen((userSnapshot) async {
          ...
          if (userModel.value.inProgressOrderID != null &&
            ...
            // ✅ FIX: Properly manage ride snapshot subscription
            _rideSnapshotSubscription?.cancel();
            _rideSnapshotSubscription = FireStoreUtils.fireStore
                .collection(CollectionName.rides)
                .doc(validRideId)
                .snapshots()
                .listen((rideSnapshot) async {
                  ...
                  if (status == Constant.driverAccepted ||
                    ...
                    // ✅ FIX: Properly manage driver snapshot subscription
                    _driverSnapshotSubscription?.cancel();
                    _driverSnapshotSubscription = FireStoreUtils.fireStore
                        .collection(CollectionName.users)
