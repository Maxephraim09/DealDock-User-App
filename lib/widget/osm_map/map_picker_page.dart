                ...
                MarkerLayer(
                  markers:
                      controller.pickedPlace.value != null
                          ? [Marker(point: controller.pickedPlace.value!.coordinates, width: 40, height: 40, child: const Icon(Icons.location_pin, size: 36, color: AppThemeData.danger300))]
                          : [],
                ),
              ],
            ),
              ...
              children: [
                ...
                Obx(() {
                  ...
                  return Container(
                    ...
                    decoration: BoxDecoration(color: AppThemeData.surface, borderRadius: BorderRadius.circular(8)),
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  IconButton(icon: const Icon(Icons.delete_forever, color: AppThemeData.danger300), onPressed: controller.clearAll),
                ],
              ),
            ],
          ),
