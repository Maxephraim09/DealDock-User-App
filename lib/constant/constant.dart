...
class Constant {
  ...
  static const globalUrl = "https://test1.climaxacademydumne.com.ng/";
  ...
  static Color statusColor({required String? status}) {
    if (status == orderPlaced) {
      return AppThemeData.brandMutedSteelBlue;
    } else if (status == orderAccepted || status == orderCompleted) {
      return AppThemeData.brandPrimaryBlue;
    } else if (status == orderRejected) {
      return AppThemeData.brandDeepBlue;
    } else {
      return AppThemeData.brandDeepBlue;
    }
  }
